...
**Lagos, Nigeria** · Mechanical Engineering (University of Lagos) · Product & frontend builder

I ship interactive web products — multi-page product UIs, live application funnels, wallet/deposit flows, and AI help widgets.
...
### 🔗 Links
- **Live product:** [Wunna Application Form](https://wunna-application-form.vercel.app/)
...
### 📌 Open to
Junior **frontend** · **web product / UI** · technical **internships** · **remote**-friendly roles

### 📈 Now
Polishing portfolio demos · Building in public · Clean energy + software crossover projects

---

⭐️ [github.com/Dev-OLAOLU](https://github.com/Dev-OLAOLU)
